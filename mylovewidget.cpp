...
#include<QHeaderView>
#include<QScrollBar>
MyLoveWidget::MyLoveWidget(QWidget *parent) : QWidget(parent)
{
    InitWidget();

    QVBoxLayout *main_lay=new QVBoxLayout(this);
    main_lay->setSpacing(10);
    main_lay->setContentsMargins(20,0,20,0);
    main_lay->addWidget(picLabel);
...
MyLoveWidget::~MyLoveWidget()
{

}
void MyLoveWidget::InitWidget()
{
    picLabel=new QLabel;
    picLabel->setPixmap(QPixmap(":/center/mylove"));
    textLabel=new QLabel("我喜欢");//标题
    ...
    searchEdit->setPlaceholderText("在我喜欢列表中搜索");
...
void MyLoveWidget::setStyle(const QString &style)
{
       QFile qss(style);
