...
#include<QHeaderView>
#include<QScrollBar>
PlayHistoryWidget::PlayHistoryWidget(QWidget *parent) : QWidget(parent)
{
    InitWidget();
...
PlayHistoryWidget::~PlayHistoryWidget()
{

}
void PlayHistoryWidget::InitWidget()
{
    textLabel=new QLabel("播放历史");//标题
    ...
    searchEdit->setPlaceholderText("在播放历史列表中搜索");
...
void PlayHistoryWidget::setStyle(const QString &style)
{
       QFile qss(style);
